...
export const metadata = createMetadata({
  ...
  description:
    "Interactive Vantage Studios: Design Studio, Cost Studio, Kitchen Studio, Attic Studio, Basement Builder, Move or Improve, and ADU Payback for North Jersey homeowners.",
  path: "/studios",
});

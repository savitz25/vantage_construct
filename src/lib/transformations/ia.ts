...
export const transformTools: TransformToolLink[] = [
  ...
  },
  {
    ...
    body: "Private retreats — bedroom, spa bath, walk-in closet — with zone design and live planning estimate.",
    badge: "New",
  },
  {
...
export const serviceToolPairs = [
  ...
  {
    servicePath: "/transformations/primary-suite",
    serviceLabel: "Primary Suite",
    toolPath: "/primary-suite-cost-nj",
    toolLabel: "Primary Suite Studio",
    openCta: "Open the Primary Suite Studio",
    learnCta: "Learn how we build primary suites",
  },
  {
